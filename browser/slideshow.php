      ...
      jQuery(function($){
        ...
        <?php
          ...
          foreach($elements_list as $element_id) {
            ...
            echo "{image: '$BASE_URL/".getResizedPath($element_id)."', title: '".htmlentities($element->title)." - <small>".$element->getSubTitle(true)."</small>', thumb: '$BASE_URL/".getThumbnailPath($element_id)."', url: '$BASE_URL/index.php?path=$path' },\n";
          }
        ?>
        ]});
      });
